...
class CreateRentalScreen extends StatefulWidget {
  ...
  const CreateRentalScreen({super.key, required this.car});
...
class _CreateRentalScreenState extends State<CreateRentalScreen> {
  ...
  Future<void> _selectEndDate() async {
    final DateTime today = DateTime.now();
    final DateTime firstAllowedDate = _startDate ?? today;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.directions_car_filled, size: 55),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _PriceRow(title: 'Rental days', value: '$_rentalDays'),

                  const SizedBox(height: 12),

                  _PriceRow(
                    title: 'Price per day',
                    value: '\$${widget.car.pricePerDay.toStringAsFixed(2)}',
                  ),
            ...
            PrimaryButton(text: 'Confirm Rental', onPressed: _confirmRental),
          ],
        ),
      ),
    );
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            color: isTotal ? AppTheme.primaryBlue : AppTheme.darkColor,
          ),
        ),
      ],
    );
